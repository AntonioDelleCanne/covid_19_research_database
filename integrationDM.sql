...
drop table if exists integration_location;
...
create table integration_location (
...
insert into integration_location (iso, geoId, country_territory_area, popData2019)
...
create table integration_area (
	...
	foreign key (iso) references integration_location(iso)
);
...
create table corona_integration_record (
    ...
    foreign key (countryterritoryCode) references integration_location(iso),
